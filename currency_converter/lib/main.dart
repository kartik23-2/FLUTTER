...
class MyCupertinoApp extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return const CupertinoApp(
      // The CupertinoApp widget is a convenience widget that wraps a number of widgets that are commonly required for iOS design applications. It provides features such as navigation, theming, and localization. By using CupertinoApp, you can easily create a consistent look and feel for your app that follows the iOS design principles.
      home:
          CurrencyConverterCupertinoPage(), // The home property of the CupertinoApp widget is used to specify the default route of the app, which is displayed when the app is launched. In this case, we are setting it to a Text widget that displays "Hello World". This means that when the app is launched, it will show a screen with the text "Hello World" in the center.
    );
  }
}
